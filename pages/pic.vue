    ...
    <section class="pb-8">
      <b-container>
        <b-row align-h="center">
          <b-col cols="12" lg="12" class="pt-3 px-3 text-center">
            ...
            <p class="mb-8 font-size-lg text-muted">
              ...
              <br />
              所有照片均为网友提供，全部照片来自于网络，如有侵权请联系complaint@chhes.com进行删除。
            </p>
          </b-col>
        </b-row>
...
<script>
import waterfall from "@parrotjs/vue-waterfall";
...
export default {
  data() {
    return {
      imgsArr: [
        {
          src: "https://gimg2.baidu.com/image_search/src=http%3A%2F%2Fimage.biaobaiju.com%2Fuploads%2F20180211%2F00%2F1518279736-ImsfeASJcb.jpg&refer=http%3A%2F%2Fimage.biaobaiju.com&app=2002&size=f9999,10000&q=a80&n=0&g=0n&fmt=jpeg?sec=1638440861&t=401c068f0a25ed2a42a4b070c6ee6a96",
        ...
        {
          src: "https://www.chhes.com/images/202110/thumb_img/1282_thumb_G_1633668789001.jpg", 
          href: "https://www.baidu.com",
          info: "一些图片描述文字",
        },
        {
