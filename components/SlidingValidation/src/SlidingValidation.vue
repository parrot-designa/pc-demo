<template>
  <div class="sliding-validation-wrapper"
    ...
    <div class="sliding-validation-top">
      <p>请完成安全验证</p>
      <i class="iconfont-slide icon-shuaxin"
         @click="handleReload()"></i>
      <i class="iconfont-slide icon-guanbi"
         @click="handleClose()"></i>
    </div>
    ...
    <div class="sliding-validation-block-wrapper">
      <div class="sliding-validation-block"
        ...
        <div class="sliding-validation-button"
          ...
          <i class="iconfont-slide icon-arrow_right_b"></i>
        </div>
      </div>
...
export default {
  ...
  methods: {
    ...
    handleClose (flag=false) {
      this.$emit('handleSlidingValidation', flag)
      return false
    }
  }
}
